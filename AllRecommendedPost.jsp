...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>All Recommended Posts </span> Based on Service Usage History </h2>
          <div class="clr"></div>
          <p>
	...
	String from="",to="",s3="",details="",id="",dt="",pname="",id1="",from1="",to1="";
	int i=0,j=0;
	...
	while ( rs1.next() )
	   {
		  ...
		  pname=rs1.getString(2);
           ...
           String query="select * from imagerecommend where imgid='"+id1+"'"; 
...
<table width="453" border="0" align="center">
  ...
  <tr>
    ...
    <td><div align="left"><a href="AllRecommendedPost1.jsp?id=<%=id%>&from=<%=from1%>&to=<%=to1%>"><strong>View&nbsp;</strong></a></div></td>
  </tr>
</table>
