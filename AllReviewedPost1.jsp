...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>All Reeviewed <span>Posts </span> Based on Service Usage History </h2>
          <div class="clr"></div>
          <p>
...
%>
 ...
 <table width="574" border="1" align="center"  cellpadding="0" cellspacing="0"  >
   <tr>
     <td width="246" rowspan="6" ><div style="margin:10px 13px 10px 13px;" > 
   ...
   <tr>
     ...
     <tr>
     <td  width="144" valign="middle" height="30" style="color: #2c83b0;"><div align="left " style="margin-left:20px;"><strong>Total Vote </strong></div></td>
   ...
   <tr>
    ...
    %>
       ...
       <tr>
     <td  width="144" valign="middle" height="41" style="color: #2c83b0;"><div align="left " style="margin-left:20px;"><strong>Reviewed By</strong                      ></div></td>
     <td  width="144" columnspan="2" valign="middle" height="41" style="color: #2c83b0;"><div align="left " style="margin-left:20px;"><strong>Reviewed Details</strong                      ></div></td>
	  <td  width="144" columnspan="2" valign="middle" height="41" style="color: #2c83b0;"><div align="left " style="margin-left:20px;"><strong>Date</strong                      ></div></td>
   </tr>
   <%
     String str="select * from review where id='"+id+"'"; 
           Statement st1=connection.createStatement();
           ResultSet rs1=st1.executeQuery(str);
	while ( rs1.next() )
	   {
	     from=rs1.getString(3);
		 details=rs1.getString(4);
		 date=rs1.getString(5);
		 %>
       <tr>
 
     <td height="30"><span class="style15">&nbsp;&nbsp;<%=from%></span></td>
 ...
 <div align="right">
   <ul class="sb_menu">
     <li><a href="AllReviewedPost.jsp"></a></li>
   </ul>
 </div>
 <p></p>
</div>
