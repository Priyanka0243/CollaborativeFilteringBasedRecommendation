    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
          <p>&nbsp;</p>
          <p><form action="insertImage.jsp" method="post" enctype="multipart/form-data">
                <table width="600" border="0"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse; display:inline; margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
					...
					<tr>
					  <td  width="188" valign="middle" height="45" style="color: #2c83b0;"><div align="left" class="style7" style="margin-left:20px;">Product Name </div></td>
					  <td  width="412" valign="middle" height="45" style="color:#000000;"><div align="left" style="margin-left:20px;"><input type="text" name="tag"></div></td>
					</tr>
					<tr>
					  <td  width="188" valign="middle" height="45" style="color: #2c83b0;"><div align="left" class="style7" style="margin-left:20px;">Product  Color </div></td>
					...
					<tr>
  						<td  width="188" valign="middle" height="45" style="color: #2c83b0;"><div align="left" class="style7" style="margin-left:20px;">Product Description <br />
					  </div></td>
					...
					<tr>
					  <td  width="188" align="left" valign="middle" height="45" style="color: #2c83b0;"><div align="left" class="style7" style="margin-left:20px;">Product Uses </div></td>
					  <td  width="412" align="left" valign="middle" height="45"><div align="left" style="margin-left:20px;"><input type="text" name="uses"></div></td>
					</tr>
					<tr>
					  <td  width="188" align="left" valign="middle" height="45" style="color: #2c83b0;"><div align="left " class="style7" style="margin-left:20px;">Made By </div></td>
					  <td  width="412" align="left" valign="middle" height="45"><div align="left" style="margin-left:20px;"><input type="text" name="location"></div></td>
					</tr>
					  <span class="style8">
				      </tr>
					  </span>
					...
					<tr>
					  <td   width="188" align="left" valign="middle" height="74" style="color: #2c83b0;"><div align="left" class="style8" style="margin-left:20px;"><strong >Select Image </strong></div></td>
