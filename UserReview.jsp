...
.style9 {font-size: 14px; color: #0099FF; }
...
<strong></strong></a><a href="index.html"></a></h1>
  ...
  <div align="center" class="style1">  
    ...
    <table width="465" border="0">
      <tr>
        <td width="143"><div align="center"><span class="style9"> ID </span></div></td>
        <td width="312"><label>
          <input type="text" name="t1" value="<%=i%>" readonly>
        </label></td>
      </tr>
      <tr>
        <td><div align="center"><span class="style9">Product Name </span></div></td>
        <td><label>
      ...
      <tr>      </tr>
      <tr>
        <td><div align="center"><span class="style9">Details</span></div></td>
