...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Recommended Sucessfully  </span></h2>
          <div class="clr"></div>
          <p><%
       ...
       try
		{
			...
			String sql="SELECT * FROM imagerecommend where recommendfrom='"+a1+"' and recommendto='"+s3+"' and imgid='"+s1+"'";
			...
			if(rs.next())
			{
				...
				response.sendRedirect("AlreadyRecommend.jsp");
			}
...
st.executeUpdate("insert into  imagerecommend (recommendfrom,recommendto,Details,imgid,date) values ('"+a1+"','"+s3+"','"+s4+"','"+s1+"','"+dt+"')" );
